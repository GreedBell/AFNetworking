...
EOS
  ...
  s.subspec 'Serialization' do |ss|
    ...
    ss.watchos.frameworks = 'MobileCoreServices', 'CoreGraphics', 'Foundation'
    ss.ios.frameworks = 'MobileCoreServices', 'CoreGraphics', 'Foundation'
    ss.osx.frameworks = 'CoreServices', 'Foundation'
  end

  s.subspec 'Security' do |ss|
    ss.source_files = 'AFNetworking/AFSecurityPolicy.{h,m}'
    ss.public_header_files = 'AFNetworking/AFSecurityPolicy.h'
    ss.frameworks = 'Security', 'Foundation'
  end
  ...
  s.subspec 'Reachability' do |ss|
    ...
    ss.frameworks = 'SystemConfiguration', 'Foundation'
  end
